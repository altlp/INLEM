function  imgDenoised  =   nonLocalMedian1(imgNoisy, h, P, S)

% Image denoising using Non-Local Euclidean Medians (NLEM)
%
...
%
% imgDenoised : image denoised using NLEM
%
% Reference:
%
